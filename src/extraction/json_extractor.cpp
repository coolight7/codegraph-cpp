/**
 * json_extractor.cpp — JSON 语言提取器实现
 *
...
JsonExtractor::JsonExtractor() : lang_(tree_sitter_json()) {}
...
void JsonExtractor::walk_tree(TSNode node, const std::string &source,
...
ExtractionResult JsonExtractor::extract(const std::string &file_path,
